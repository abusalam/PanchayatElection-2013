...
function initSRER()
{
	...
	$_SESSION['Debug']=GetVal($_SESSION,'Debug')."InInitPage(".GetVal($_SESSION,'PE2013_TOKEN')."=".GetVal($_COOKIE,'PE2013_TOKEN').")";
	setcookie("PE2013_TOKEN",$sess_id,(time()+(LifeTime*60)));
...
function CheckAuth()
{
    ...
    else if($_SESSION['PE2013_TOKEN']!=$_COOKIE['PE2013_TOKEN'])
    {
...
function srer_auth()
{
	...
	else
	{
		if($SessRet!="Valid")
		{
			...
			session_start();
			$_SESSION=array();
			$_SESSION['Debug']=GetVal($_SESSION,'Debug').$SessRet."PE2013_TOKEN-!Valid";
			header("Location: ".BaseDIR."index.php");
			exit;
		}
		else
		{
			$_SESSION['Debug']=GetVal($_SESSION,'Debug')."PE2013_TOKEN-IsValid";
			$sess_id=md5(microtime());
			setcookie("PE2013_TOKEN",$sess_id,(time()+(LifeTime*60)));
			$_SESSION['PE2013_TOKEN']=$sess_id;
			$_SESSION['LifeTime']=time();
